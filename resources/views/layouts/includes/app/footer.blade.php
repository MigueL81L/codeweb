<footer class="bg-white dark:bg-gray-900 mt-16">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="{{ route('home') }}" class="hover:underline">CodeWeb™</a>. Todos los Derechos Reservados.</span>
            <div class="flex mt-4 sm:justify-center sm:mt-0">
                ...
                <!-- Puedes agregar más íconos de redes sociales si lo deseas -->
            </div>
        </div>
    </div>
</footer>
