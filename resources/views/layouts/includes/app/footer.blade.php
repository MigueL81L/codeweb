        ...
        <div class="flex flex-col items-center text-center sm:flex-row sm:text-left sm:items-start md:justify-between"> 
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-12 flex-grow w-full sm:w-auto">
                ...
                <div class="flex flex-col sm:items-start sm:text-left md:items-center md:text-center">
                    <h2 class="mb-6 font-semibold text-gray-900 uppercase dark:text-white">Nosotros</h2>
                ...
                <div class="flex flex-col sm:items-start sm:text-left md:items-center md:text-center">
                    <h2 class="mb-6 font-semibold text-gray-900 uppercase dark:text-white">Compañía</h2>
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-2">
