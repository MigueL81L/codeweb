        ...
        <div class="pt-4 pb-12 bg-gray-100 dark:bg-gray-900">
            <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
                ...
                <div class="w-full sm:max-w-2xl mt-6 p-6 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg prose dark:prose-invert">
                    <h1 class="text-3xl font-bold mb-4 text-center">Política de Privacidad</h1> <!-- Título de sección -->
                    ...
                    <ul class="list-disc list-inside mt-2 text-gray-700 dark:text-gray-300">
                        <li>Facilitar el acceso a nuestros cursos.</li>
                        <li>Brindar soporte al usuario.</li>
                        <li>Notificar sobre cambios y actualizaciones.</li>
                        <li>Enviar comunicados y ofertas relevantes.</li>
