...
<x-app-layout>
    ...
    {{-- <section style="background-image: url({{ asset('img/cursos/matriculados.png') }})" class="bg-cover"> --}}
        <section style="background-image: url({{ asset('img/logo/matriculados.png') }})" class="bg-cover">
