                ...
                @if ($similares->count()!=0)
                    @foreach ($similares as $similar)
                        <article class="flex mb-6">
                            ...
                            <div class="ml-3">
                                <h1 class="group"><a class="font-bold text-gray-500 cursor-pointer group-hover:text-blue-400" href="{{route('courses.show', $similar)}}">{{Str::limit($similar->title, 30)}}</a></h1>
