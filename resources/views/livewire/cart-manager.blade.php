...
<div style="background-image: url({{ asset('public/img/cursos/carrito.jpg') }})" class="bg-cover"> 
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-36">
        ...
        <div class="w-full md:w-3/4 lg:w-1/2">
            ...
            @if ($cartContent->isEmpty())  
                <h1 class="text-2xl font-bold mb-6 text-center sm:text-start text-white">Contenido de la Cesta</h1> 
                <p class="text-center font-bold sm:text-start text-white">No hay elementos en la Cesta.</p>
            @else
                <div class="bg-white p-6 rounded-lg shadow-lg">
