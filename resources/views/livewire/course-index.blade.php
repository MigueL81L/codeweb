        ...
        <div class="grid grid-cols-5 gap-x-4">
            ...
            <div class="col-span-2">
                <form wire:submit.prevent="filterCategories" class="flex items-center justify-end space-x-4">
                    <div>
                        <select wire:model="selectedCategory" id="selectedCategories" name="selectedCategories" class="h-10 border-gray-300 rounded-lg">
            ...
            <div class="col-span-2">
                <form wire:submit.prevent="filterLevels" class="flex items-center justify-end space-x-4">
                    <div>
                        <select wire:model="selectedLevel" id="selectedLevels" name="selectedLevels" class="h-10 border-gray-300 rounded-lg">
