        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> 
            <div class="grid grid-cols-1 md:grid-cols-6 gap-y-4 md:gap-x-4">
                ...
                <div class="md:col-span-2">
                    <form wire:submit.prevent="filterPrices" class="flex items-center justify-between md:justify-end space-x-2">
                        <label class="flex-1">
                ...
                <!-- Filtro por Categoría -->
                <div class="md:col-span-2">
                    <form wire:submit.prevent="filterCategories" class="flex items-center justify-between md:justify-end space-x-2">
                        <label class="flex-1">
                ...
                <!-- Filtro por Nivel -->
                <div class="md:col-span-2">
                    <form wire:submit.prevent="filterLevels" class="flex items-center justify-between md:justify-end space-x-2">
                        <label class="flex-1">
