<div>
    <div class="bg-gray-200 py-4 mb-16">  
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex"> 
            <div class="grid grid-cols-1 md:grid-cols-3 md:gap-x-4 md:py-4">
                <!-- Filtro por Precio -->
                <div class="col-span-1">
                    <form wire:submit.prevent="filterPrices" class="flex items-center justify-between space-x-0 sm:justify-center sm:space-x-4">
                        <div>
                ...
                <div class="col-span-1">
                    <form wire:submit.prevent="filterCategories" class="flex items-center justify-between space-x-0 sm:justify-center sm:space-x-4">
                        <div>
                ...
                <!-- Filtro por Nivel -->
                <div class="col-span-1">
                    <form wire:submit.prevent="filterLevels" class="flex items-center justify-between space-x-0 sm:justify-center sm:space-x-4">
                        <div>
