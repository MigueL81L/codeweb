<div>
    <div class="bg-gray-200 py-4 mb-16">  
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-center">  
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-4 lg:py-4 lg:px-4"> 
                <!-- Filtro por Precio -->
                <div class="col-span-1">
                    <form wire:submit.prevent="filterPrices" class="flex items-center justify-between  lg:justify-center">
                        ...
                        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded justify-end lg:justify-center mb-2 lg:mb-0 mr-2 lg:mr-4">
                ...
                <div class="col-span-1">
                    <form wire:submit.prevent="filterCategories" class="flex items-center justify-between lg:justify-center">
                        <div class="flex-grow mr-2">
                ...
                <!-- Filtro por Nivel -->
                <div class="col-span-1">
                    <form wire:submit.prevent="filterLevels" class="flex items-center justify-between  lg:justify-center">
                        <div class="flex-grow mr-2" >
