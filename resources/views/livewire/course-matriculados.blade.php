        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-center">  
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-4 lg:py-4 lg:px-4"> 
                ...
                <div class="col-span-1">
                    <form wire:submit.prevent="filterPrices" class="flex items-center justify-around  ">
                ...
                <div class="col-span-1">
                    <form wire:submit.prevent="filterCategories" class="flex items-center justify-around ">
                        <div class="flex-grow mr-2">
                ...
                <!-- Filtro por Nivel -->
                <div class="col-span-1">
                    <form wire:submit.prevent="filterLevels" class="flex items-center justify-around  ">
                        <div class="flex-grow mr-2" >
